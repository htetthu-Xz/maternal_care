...
<body>
    ...
    <section class="chapter-list py-4 mx-auto">
        <h5 class="fw-bold text-primary mb-4 text-center">
            ...
            အခန်း ၃ - ကိုယ်ဝန်ဆောင်မိခင်များအတွက် အန္တရာယ်လက္ခဏာများ
        </h5>
                ...
                <div class="list-group-item d-flex align-items-start gap-3 flex-wrap">
                    ...
                    <div class="flex-grow-1">
                        <div class="chapter-desc mb-2">
                            အောက်ပါအခြေနေများဖြစ်ပါက ဆေးရုံ၊ဆေးခန်း၊ ကျန်းမာရေး ဌာနသို့ နေ့ညမဆိုင်းချက်ချင်းပြပါ
                        </div>
                        <div class="chapter-desc mb-2">
                            <small class="text-secondary">
                                <ul>
                                    <li>ခေါင်းပြင်းထန်စွာကိုက်ပြီး အမြင်မှုံဝါးခြင်း</li>
                                    <li>ဝမ်းဗိုက်အလွန်မင်းဆက်တိုက်နာခြင်း</li>
                                    <li>ရင်ညွန့်သို့ ညာဘက်နံရိုးအောက် အောင့်ခြင်း</li>
                                    <li>တက်ခြင်း၊ သတိလစ်ခြင်း</li>
                                    <li>ဖျားပြီးအိပ်ရာမှ မထနိုင်လောက်အောင် အားနည်းခြင်း</li>
                                    <li>အသက်ရှူမြန်ခြင်းနှင့်အသက်ရျူခတ်ခြင်း</li>
                                </ul>
                            </small>
                        </div> 
                    </div>
        ...
        <div class="d-flex justify-content-between align-items-center text-muted small mt-3">
            ...
            <span><i class="bx bx-book"></i> 3 of 12</span>

...
<body>
    ...
    <section class="chapter-list py-4 mx-auto">
        <h5 class="fw-bold text-primary mb-4 text-center">
            ...
            အခန်း ၂ - ကိုယ်ဝန်ဆောင်မိခင် တို့ရှောင်ရန်အချက်များ
        </h5>
        ...
        <div class="mb-4">
            <div class="list-group">
                <div class="list-group-item d-flex align-items-start gap-3 flex-wrap">
                    ...
                    <div class="flex-grow-1">
                        <div class="chapter-desc mb-2">
                            မူးယစ်ဆေးဝါး ဆေးလပ်၊ အရက် နှင့် ကွမ်းစားခြင်းတို့ကိုလုံးဝမ ရှောင်ကြဉ်ပါ။ ဆေးလိပ်ငွေ မီးခိုးငွေ့ အစရှိသည့်ညစ်ညမ်းသော လေထု ပတ်ဝန်ကျင်ကို ရှောင်ရှားပါ။
                        </div>
                        <img src="{{ asset('images/smoke.png') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 320px;">
                    </div>
                </div>
                <div class="list-group-item d-flex align-items-start gap-3 flex-wrap">
                    <span class="fs-4 text-success"><i class="bx bx-check-circle"></i></span>
                    <div class="flex-grow-1">
                        <div class="chapter-desc mb-2">
                            ပက်လက်အနေထားဖြင့်လုံးဝ မအိပ်ရ။
                        </div>
                        <div class="chapter-desc mb-2">
                            <small class="text-secondary">
                                ပင်ပမ်းသော အလုပ်များမလုပ်ရ၊ အလေးပင်မသောအလုပ်များ မလုပ်ပါနင့်။ ဒေါက်မြင်ဖိနပ်လုံးဝမစီရ။
                            </small>
                        </div>      
                    </div>
                </div>
                <div class="list-group-item d-flex align-items-start gap-3 flex-wrap">
                    ...
                    <div class="flex-grow-1">
                        <div class="chapter-desc mb-2">
                            ကိုယ်ဝန်ဆောင်စဉ် ဆံပင်ဆေးဆိုးခြင်းမှ ရှောင်ကျင်ပါ။ 
                        </div>
                        <div class="chapter-desc mb-2">
                            <small class="text-secondary">
                                သက်တောင့်သက်သာမရှိသော (ဗိုက်တင်းကျပ်စေနိုင်သော) အကျီဘောင်းဘီ လုံချည်နှင့်စကက်များ ဝတ်ဆင်ခြင်းကို ရှောင်ကြဉ်ပါ။
                            </small>
            ...
            <div class="d-flex justify-content-between align-items-center text-muted small mt-3">
                <a href="{{ route('knowledges.chapter1') }}" class="btn btn-outline-primary btn-sm">
                    <i class="bx bx-left-arrow-alt"></i> ရှေစာမျက်နှာ
                </a>
                <span><i class="bx bx-book"></i> 2 of 12</span>

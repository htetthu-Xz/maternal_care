...
<body>
    ...
    <section class="chapter-list py-4 mx-auto">
        <h5 class="fw-bold text-primary mb-4 text-center">
            ...
            အခန်း ၈ - မွေးဖွားခါပြီးမိခင်များအတွက် အန္တရာယ်လက္ခဏာများ
        </h5>
                ...
                <div class="list-group-item d-flex align-items-start gap-3 flex-wrap">
                    ...
                    <div class="flex-grow-1">
                        <div class="chapter-desc mb-2">
                            မီးတွင်းချိန်တွင် အောက်ပါအခြေနေများများဖြစ်ပေါ်ပါက ဆေးရုံ/ဆေးခန်း ကျန်းမာရေးဌာနသို့နေညမဆိုင်းသွားပါ။
                        </div>
                        <div class="chapter-desc mb-2">
                            <small class="text-secondary">
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/headache.jpg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 120px">
                                            <small>ခေါင်းအလွန်ကိုက်ပြီး <br> အမြင်မုန်ဝါးလျှင်</small>
                                        </div>
                                    </div>
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/blood.jpg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 120px">
                                            <small>သွေးဆင်းလျှင် <br></small>
                                        </div>
                                    </div>
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/pain.jpeg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 120px">
                                            <small>အလွန်အမင်းဗိုက် <br> အောင်လျှင်</small>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/tat.jpg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 100px">
                                            <small>တက်လျှင်</small>
                                        </div>
                                    </div>
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/fever.jpg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 100px">
                                            <small>ဖျားပြီးအိပ်ရာမှမထနိုင် <br> လောက်အောင် အားနည်းလျှင် </small>
                                        </div>
                                    </div>
                                    <div class="card p-2 m-3">
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 140px">
                                            <img src="{{ asset('images/breath.jpg') }}" alt="Healthy Food" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100px; max-height: 100px">
                                            <small>အသက်ရှူမြန်လျှင် <br> အသက်ရှူခတ်လျှင်</small>
                                        </div>
                                    </div>
                                </div>
                            </small>
        ...
        <div class="d-flex justify-content-between align-items-center text-muted small mt-3">
            ...
            <span><i class="bx bx-book"></i> 8 of 12</span>

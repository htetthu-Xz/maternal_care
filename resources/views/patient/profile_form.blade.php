...
<div class="container py-4">
    <div class="card shadow-sm p-4">
        <h2 class="text-center fw-bold mb-3">
            ...
            <small class="text-muted">(Emergency Preparedness Form for Pregnant Women)</small>
        </h2>
        ...
        <form action="{{ route('patient.profile.submit') }}" method="POST">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <label class="form-label">အဖေ၏အမည် (Father’s Name)</label>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="father_blood_group">
            ...
            <h4 class="fw-semibold border-bottom pb-2 mb-3">
                ...
                <small class="text-muted">Emergency Planning</small>
            </h4>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                <label class="form-label">ကလေးမွေးဖွားရန်သာဖွားကျွမ်းကျင်သူတစ်ဉီး ဉီးကိုရွေးချယ်ထားပါသလား</label>

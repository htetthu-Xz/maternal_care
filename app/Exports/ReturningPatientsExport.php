...
class ReturningPatientsExport implements FromCollection, WithHeadings, \Maatwebsite\Excel\Concerns\WithStyles, \Maatwebsite\Excel\Concerns\WithTitle, \Maatwebsite\Excel\Concerns\WithCustomStartCell, \Maatwebsite\Excel\Concerns\WithEvents
{
    public function collection()
    {
        return Patient::whereHas('careSteps', function ($query) {
    ...
    {
        return 'ရက်ချိန်းလူနာများစာရင်း';
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function (BeforeSheet $event) {
                $event->sheet->setCellValue('A1', 'ရက်ချိန်းလူနာများစာရင်း');
